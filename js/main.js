...
var $draggable;
	...
	function onDeviceReady() {
		...
		window.ga.startTrackerWithId('UA-1466312-14', 30);
		window.ga.trackView('LDS Prophets and Apostles');
		window.ga.trackEvent('App', 'Begin', 'Version', free_version);
